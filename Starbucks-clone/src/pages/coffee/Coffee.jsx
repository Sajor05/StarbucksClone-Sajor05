  ...
  return (
    <>
        ...
        <div>
            ...
            <main className="main-container flex flex-col gap-8 text-[20px] text-[#000000DE]">
                ...
                <div>
                    <h2 className="font-bold text-[30px] text-black mb-10">Nuestro tostado Starbucks</h2>
                ...
                <ToastType type={"Rubio"} text={"El café Starbucks tostado rubio es tostado en menos tiempo, tiene un cuerpo ligero y sabores suaves."}/>
                <ToastType type={"Medio"} text={"El café con tostado medio es balanceado con sabores agradables y enriquecidos."}/>
                <ToastType type={"Oscuro"} text={"Los cafés con tostado oscuro presentan un cuerpo completo y sabores fuertes y robustos."}/>
                <div className="flex flex-col gap-5">
                    <h2 className="font-bold text-[30px] text-black">
                        Descubre los métodos de preparación en <span className="block">Starbucks, ¿Cuál es el correcto para vos?</span>
                    </h2>
                    ...
                    <a 
                        ...
                        <span className="font-bold text-[18px]">Conocé nuestros métodos</span>
                    </a>
                </div>
            </main>
        </div>
