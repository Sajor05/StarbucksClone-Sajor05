...
export const ExperienceCard = ({
  ...
  return (
    <div className="flex flex-row w-300 h-87.5">
      <div
        className={`flex flex-col w-150 px-8 py-8 gap-6 bg-[#f1ece8] ${isReversed ? "order-last" : ""}`}
      >
        ...
        {isDelivery ? (
          <div className="text-center">
            <Link
              ...
              className="button mt-5 w-33.5 h-8"
            >
      ...
      <div>
        <img src={image} alt={title} className="w-150 h-87.5" />
      </div>
    </div>
  );
};
